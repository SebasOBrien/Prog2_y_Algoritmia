...
void apilar(struct Pila & pila, struct NodoArbol * nodoArbol) {
    insertarAlInicio(pila.lista, nodoArbol);
...
struct NodoArbol * desapilar(struct Pila & pila) {
    ...
    struct NodoArbol * nodoArbol = cima(pila);
...
struct NodoArbol * cima(const struct Pila & pila) {
